...
export const es = {
  ...
  team: [
    ...
    { name: "Agustín Ortiz", role: "Director de Marketing (CMO)", location: "Uruguay", bio: "Agustín Ortiz tiende el puente entre la gobernanza criptográfica de IA y la adopción empresarial. Sin ruido. Ejecución determinística pura.", hoverLine: "Arquitectando la narrativa de confianza determinística para la economía autónoma M2M." }
  ],
  roadmap: { phases: [
