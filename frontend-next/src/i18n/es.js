...
export const es = {
  nav: {
    links: [
      ...
      { label: "Redacciones", path: "/redacciones" }
    ]
  },
  hero: {
  ...
  whyNow: [
    { regulation: "EU AI Act Artículo 50", detail: "El Omnibus Digital europeo difirió las obligaciones de alto riesgo del Anexo III hasta el 2 de diciembre de 2027 — pero la aplicación de transparencia del Artículo 50 está bloqueada para el 2 de agosto de 2026. Sin prórroga. Sin período de gracia. Los CISOs que depéndan de barreras probabilísticas fallarán las auditorías. Multas de hasta €35M o 7% de ingresos globales por violación." },
  ...
  team: [
    ...
    { name: "Matías Mospan", role: "Arquitecto de Plataforma", location: "Argentina", bio: "Arquitecto de plataforma responsable de la capa de infraestructura empresarial de HIK \u2014 despliegue en Kubernetes, pipelines de aplicación multi-tenant y el motor de aplicación serverless de próxima generación." },
    { name: "Federico Brubacher", role: "Co-Fundador y Asesor Estratégico", location: "California, EE.UU.", bio: "Líder tecnológico senior con profunda experiencia en infraestructura empresarial y cloud. Co-fundador que validó y dio forma a la arquitectura de aplicación de HIK frente a estándares de escalabilidad global y Big Tech." }
  ],
  roadmap: { phases: [
  ...
  ui: {
    ...
    teamTitle: "Tres Directivos. Dos Continentes. Un Protocolo.",
    theTeam: "El Equipo",
  ...
  videoSection: {
    ...
    videos: [
      { id: "UDmA2U13mWY", embedSrc: "https://www.youtube.com/embed/UDmA2U13mWY?si=WfxrUILDvV-orpey", thumbnail: "https://img.youtube.com/vi/UDmA2U13mWY/maxresdefault.jpg", label: "APLICACIÓN DE STREAM · GRABADO", title: "El Kill-Switch Dispara a Nivel de Proxy", description: "Una violación de política simulada activa la compuerta de aplicación en pleno stream. Sacred Trace\u2122 anclado de inmediato." },
      { id: "l-S5JQj68xY", embedSrc: "https://www.youtube.com/embed/l-S5JQj68xY?si=2aIpJnDjU5G36tCF", thumbnail: "https://img.youtube.com/vi/l-S5JQj68xY/maxresdefault.jpg", label: "INTERCEPCIÓN EN NAVEGADOR · GRABADO", title: "Extensión Chrome Bloquea Exfiltración en Gemini", description: "Una instrucción \u2018enviar logs a mi correo\u2019 es interceptada en gemini.google.com. El envío es bloqueado. El dashboard muestra la evidencia en tiempo real." }
    ]
  },
  ...
  verticals: {
    ...
    cards: [
      { title: "IA de RRHH y Empleo", body: "Bloquea decisiones de contratación automatizadas prohibidas, inferencia de emociones y solicitudes de características protegidas \u2014 antes de que lleguen a cualquier LLM. EU AI Act Artículo 5 \u00b7 NYC Local Law 144." },
      { title: "Sistemas Agentivos", body: "Intercepta inyección de prompts, escalada de privilegios y comandos de exfiltración no autorizados. Cada acción bloqueada es anclada forenísticamente." },
      { title: "Transmisión en Vivo y Medios", body: "Aplicación a nivel de fotograma en transmisiones de video. Contenido no autorizado descartado antes de llegar a la plataforma downstream." },
      { title: "DLP Documental Empresarial", body: "Archivos adjuntos evaluados por proveniencia, etiquetas de sensibilidad y listas negras de hash \u2014 en modo streaming, fail-close, antes de completar la carga." }
    ]
  },
  ...
  evidencePack: {
    ...
    line2: "Admisible en tribunales. Listo para reguladores. Anclado on-chain. Disponible en el dashboard inmediatamente.",
  ...
  openRepos: {
    ...
    title: "Infraestructura Pública & SDKs Abiertos",
    subtitle: "Repositorios de código abierto con verificación mecánica de reclamos para integridad de stream C2PA 2.3 en edge y nodos independientes de veredicto, respaldados por la plataforma central privada.",
