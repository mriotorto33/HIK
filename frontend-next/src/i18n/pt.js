...
export const pt = {
  ...
  team: [
    ...
    { name: "Agustín Ortiz", role: "Diretor de Marketing (CMO)", location: "Uruguai", bio: "Agustín Ortiz faz a ponte entre a governança criptográfica de IA e a adoção empresarial. Zero ruido. Execução determinística pura.", hoverLine: "Arquitetando a narrativa de confiança determinística para a economia autônoma M2M." }
  ],
  roadmap: { phases: [
