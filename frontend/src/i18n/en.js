...
export const en = {
  ...
  hero: {
    ...
    cta: {
      primary: { text: "Request a Compliance Demo", link: "/executive-summary" },
  ...
  whyNow: [
    { regulation: "EU AI Act Article 50", detail: "Enforcement begins August 2, 2026. Fines up to \u20ac35M or 7% of global revenue per violation. The gap is not awareness — the gap is tooling." },
  ...
  ui: {
    ...
    teamTitle: "Three People. Two Continents. One Protocol.",
    theTeam: "The Team",
    signedBy: "Signed By",
