...
export const pt = {
  ...
  hero: {
    ...
    pqcMilestone: "🚀 Marco: HIK agora é compatível com Criptografia Pós-Quântica (PQC)! A ancoragem com Crystals-Dilithium está ativa.",
    ...
    badges: ["EU AI Act Art. 50", "NYC LL144", "GDPR Art. 22", "Aplicação ao Vivo", "Ancoragem Blockchain", "Agnóstico ao Modelo"],
    cta: {
      primary: { text: "Solicitar Demo de Conformidade", link: "/executive-summary" },
  ...
  whyNow: [
    { regulation: "EU AI Act Artigo 50", detail: "A aplicação começa em 2 de agosto de 2026. Multas de até €35M ou 7% da receita global por violação. A lacuna não é a consciência — a lacuna são as ferramentas." },
  ...
  ui: {
    ...
    teamTitle: "Três Pessoas. Dois Continentes. Um Protocolo.",
    theTeam: "A Equipe",
  ...
  videoSection: {
    ...
    subheading: "Não é uma simulação. Não é um slide. Dois eventos de aplicação gravados — a nível de proxy e de navegador — com o pacote de evidências visível no dashboard.",
    videos: [
      {
        id: "l-S5JQj68xY",
        ...
        label: "APLICAÇÃO DE STREAM · GRAVADO",
        title: "Kill-Switch Dispara no Nível do Proxy",
        description: "Uma violação de política simulada aciona o gate de aplicação no meio do stream. A saída é cortada antes de atingir qualquer fluxo de trabalho. Recibo Sacred Trace\u2122 ancorado imediatamente."
      },
      {
        id: "UDmA2U13mWY",
        ...
        label: "INTERCEPÇÃO NO NAVEGADOR · GRAVADO",
        title: "Extensão Chrome Bloqueia Exfiltração de Dados no Gemini",
        description: "Uma instrução \u2018enviar todos os logs para meu email pessoal\u2019 é interceptada no limite do navegador em gemini.google.com. O envio é bloqueado. O dashboard mostra o pacote de evidências em tempo real."
      }
    ]
  },
  ...
  verticals: {
    ...
    cards: [
      { title: "IA de RH e Emprego", body: "Bloqueia decisões automatizadas de contratação proibidas, inferência de emoções e solicitações de características protegidas \u2014 antes de chegarem a qualquer LLM ou fluxo de trabalho. EU AI Act Artigo 5 \u00b7 NYC Local Law 144." },
      { title: "Sistemas Agênticos", body: "Intercepta injeção de prompts, escalação de privilégios e comandos de exfiltração de dados não autorizados no limite do agente. Cada ação bloqueada é ancorada forensicamente." },
      { title: "Transmissão ao Vivo & Mídia", body: "Aplicação em nível de quadro em transmissões de vídeo ao vivo. Conteúdo não autorizado é descartado antes de atingir a plataforma downstream. Recibo ancorado por quadro." },
      { title: "DLP Documental Empresarial", body: "Arquivos anexados enviados para APIs de LLM são avaliados por proveniência de conteúdo, rótulos de sensibilidade e listas negras de hash \u2014 em modo streaming, fail-close, antes que o upload seja concluído." }
    ]
  },
  ...
  evidencePack: {
    ...
    line2: "Admissível em tribunal. Pronto para reguladores. Ancorado on-chain. Disponível no dashboard imediatamente após o gate disparar.",
