      ...
      <section className="relative pt-16 sm:pt-[72px] overflow-hidden">
        <div className="relative bg-[#1C1C1C] pt-12 sm:pt-16 pb-16 sm:pb-20">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-5 sm:px-6 lg:px-8">
            <p className="hero-subtitle text-xs uppercase tracking-[0.3em] text-[#E8761D] mb-4 sm:mb-5 font-semibold">Human Is Kind™ — Est. 2026</p>
            <h1 className="hero-desc text-3xl sm:text-4xl md:text-6xl font-extrabold text-white tracking-tight leading-[1.1] mb-4 sm:mb-5">The Founders' Manifesto</h1>
            <p className="hero-desc text-base sm:text-lg text-white/45 leading-relaxed">On why deterministic governance is not a feature — it is the foundation.</p>
          </div>
        </div>
      ...
      <section className="section-spacing bg-[#F7F7F7]">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          ...
          <div className="reveal text-center mt-10 sm:mt-12">
            ...
            <p className="text-xs text-[#9B9B9B] mt-2">HIK™ and Sacred Trace™ are trademarks in registration. Licensed under FCL-1.0-Apache-2.0.</p>
          </div>
        </div>
      </section>
    </div>
